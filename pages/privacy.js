...
const Privacy = () => {
  return (
    <div>
      <Head>
        <title>Guess - Privacy</title>
      </Head>

      <div className="shadow rounded bg-gray-800 text-gray-200 leading-normal text-lg">
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Guess!.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Guess!, accessible from
            https://guess-ten.vercel.app
          </li>
          <li>
        ...
        <ul>
          <li>By email: eusholli@gmail.com</li>
        </ul>
      </div>
    </div>
  );
